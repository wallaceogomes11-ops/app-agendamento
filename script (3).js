...
function aplicarCabecalho() {
  ...
  if (!brandIcon || !cfg.LOGO_FILENAME) return;

  // Substitui a tesoura pela logo diretamente
  const logoSrc = 'assets/' + cfg.LOGO_FILENAME;
  brandIcon.innerHTML =
    '<img src="' + logoSrc + '" alt="Logo" ' +
    'style="width:100%;height:100%;object-fit:cover;border-radius:6px;" ' +
    'onerror="this.parentElement.innerHTML=\'<svg viewBox=\\\"0 0 24 24\\\" fill=\\\"none\\\" stroke=\\\"currentColor\\\" stroke-width=\\\"1.5\\\" stroke-linecap=\\\"round\\\" stroke-linejoin=\\\"round\\\"><circle cx=\\\"6\\\" cy=\\\"6\\\" r=\\\"3\\\"/><circle cx=\\\"6\\\" cy=\\\"18\\\" r=\\\"3\\\"/><line x1=\\\"20\\\" y1=\\\"4\\\" x2=\\\"8.12\\\" y2=\\\"15.88\\\"/><line x1=\\\"14.47\\\" y1=\\\"14.48\\\" x2=\\\"20\\\" y2=\\\"20\\\"/><line x1=\\\"8.12\\\" y1=\\\"8.12\\\" x2=\\\"12\\\" y2=\\\"12\\\"/></svg>\'" ' +
    '/>';
}
