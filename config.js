...
const BARBERSHOP_CONFIG = {
  ...
  HORARIOS: [
    '08:00', '08:11', '09:00', '10:00', '11:00', '12:00', '12:11', '13:00', '14:00', '15:00', '16:00', '17:00',
  ],
  ...
  IMAGENS: [
    ...
    'assets/services/criar-app.jpg',
    'assets/services/aluguel.jpg',
    'assets/services/personalizar.png',
  ...
  /* ── 8. INTERVALO DE ATUALIZACAO (ms) ───────────
     ...
     Padrao: 30 segundos.                          */
  /* ── 9. LOGO ─────────────────────────────────────
     Nome do arquivo da logo dentro de assets/
     Ex: 'logo.png'. Deixe vazio se usar icone padrao. */
  LOGO_FILENAME: 'WhatsApp Image 2026-05-10 at 15.51.13.jpeg',
